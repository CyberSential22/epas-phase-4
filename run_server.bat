...
echo.
echo  ══════════════════════════════════════════════════════════
echo   Event Planner ^& Approval System — Phase 4: Workflow Engine
echo  ══════════════════════════════════════════════════════════
echo.
...
echo.
echo [7/7] Seeding Phase 4.5 sample data...
...
echo.
echo  ══════════════════════════════════════════════════════════
echo   [SUCCESS] Phase 4.5 Environment Ready!
echo  ════════════════════════════════════════════════════════════════════
echo.
...
echo   - student_test   [Student]
echo   - faculty_test   [Faculty]
echo   - head_test      [Dept Head]
echo   - admin_test     [Administrator]
echo.
